...
ORDER by uid DESC";
    ...
    <?php
$status="";
$qry="select * from internpersnoldetail order by uid Asc";
...
<?php
  while($row=mysqli_fetch_array($rs))
  {
    ...
    <td> <a href="intrndetail.php?uid=<?php echo $row["uid"];?>"> <?php echo $row["uid"];?></a>
    </td>
    <td> <a href="intrndetail.php?uid=<?php echo $row["uid"];?>"> <?php echo $row["name"];?></a></td>
...
<td>
        ...
        <button onclick="document.getElementById('id01').style.display='block'" id="button_color"><a href="internedit.php?uid=<?php echo $row["uid"];?>" style="color:white;">update</button>
  ...
  <form class="modal1-content" action="" method="POST">
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <button type="button" onclick="document.getElementById('id01').style.display='none'" class="updatebtn"><a href="internupdate.php?uid=<?php echo $row["uid"];?>">update</a></button>
      </div>
    </div>
  </form>
</div>        
  ...
  <form class="modal1-content" action="" method="POST">
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <button type="button" onclick="document.getElementById('id02').style.display='none'" class="deletebtn"><a href="intern_delete.php?uid=<?php echo $row["uid"];?>">Delete</a></button>
      </div>
    </div>
  </form>
</div>      
