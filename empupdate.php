...
{
$qry="update emppersonaldetail set pfile='$file', full_name='$name', email='$email', mobile_no.='$phone', email='$email', aadhar_number='$aadhar', pancard='$pan', gender='$gender', 
...
pincode='$pincode', join_date='$joindate'
where id='$pid'";
$rs=executequery($qry);
if($rs=="success")
{
 ...
 <div class="col-sm-3 form-group" style="margin-top: -20px;">
    ...
    <div class="picture-container">
        <div class="picture" style="height: 170px; width: 170px; margin-top: 25px;">
         ...
         <h6 class="">Choose Picture</h6>
          ...
          <div class="col-sm-9 form-group" style="margin-top: -20px;">
            ...
            <input type="text" class="form-control" name="name" id="name-f" placeholder=" Full Name." required value="<?php echo $full_name;?>"/><br>
            <label for="email">Email:</label>
            <input type="email" class="form-control" name="email" id="name-l" placeholder=" Email" required value="<?php echo $email;?>" />
          </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="gender" id="name-l" placeholder="  Gender " required value="<?php echo $gender;?>">
      </div>
      <div class="col-sm-6 form-group">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="bloodgroup" id="address-1" placeholder=" Blood Group" required value="<?php echo $bloodgroup;?>">
      </div>
      ...
      <div class="col-sm-6 form-group">
        <label for="pan_no"> Father Occupation</label>
